            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row lg:items-start lg:justify-start">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-lg border-2 px-7 py-3.5 text-base font-semibold transition hover:bg-black/5"
                  style={{ borderColor: "#1A2B3C40", color: "#1A2B3C" }}
                >
        ...
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 rounded-lg border-2 px-7 py-3.5 text-base font-semibold transition hover:bg-white/10"
              style={{ borderColor: "rgba(249,245,235,0.3)", color: "#F9F5EB" }}
            >
              Ver demo primero
            </a>
          </div>
      ...
      <footer className="border-t py-10" style={{ borderColor: "#1A2B3C15", backgroundColor: "#F9F5EB" }}>
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-6 sm:flex-row">
          ...
          <div className="flex gap-6 text-sm" style={{ color: "#1A2B3C60" }}>
            ...
            <a href={DEMO_LINK} target="_blank" rel="noopener noreferrer" className="transition hover:text-gray-700">Demo</a>
